...
// Sample-level keys carry no logDir: `logFile` is a canonical absolute
// URI (globally unique across dirs), and no group invalidation sweeps
// samples by dir — dir-prefix ops exist only on dir-level families
// (log rows, samples listings, sync).
